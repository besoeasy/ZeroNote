<template>
  <div class="p-4 bg-white rounded-xl border border-gray-200 shadow-sm dark:bg-slate-950 dark:border-slate-800">
    <div class="text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wide dark:text-slate-400">Pinned</div>
    <div class="flex items-center gap-2">
      <span class="text-2xl">📌</span>
      <span class="text-sm text-gray-900 font-medium dark:text-slate-100">
