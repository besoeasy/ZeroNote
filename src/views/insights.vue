<template>
  <div class="min-h-screen w-full p-4 md:p-8 max-w-5xl mx-auto flex flex-col gap-10">
    <!-- Loading State -->
    <div v-if="isLoading" class="flex flex-col justify-center items-center py-32 space-y-4">
      ...
      <p class="text-gray-400 font-medium animate-pulse dark:text-slate-500">Crunching the numbers...</p>
    </div>
    ...
    <div v-else class="space-y-12 animate-fade-in-up">
      ...
      <div class="text-center space-y-3">
        <h1 class="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-gray-900 dark:text-slate-100">Insights</h1>
        <p class="text-base sm:text-lg text-gray-600 dark:text-slate-400 max-w-2xl mx-auto">Your workspace analytics and app information</p>
      </div>
      <!-- Stats Section -->
      <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          >
            ...
            <div class="relative z-10">
              <div class="flex items-center justify-between mb-4">
                <div class="p-3 bg-blue-50 rounded-2xl group-hover:bg-blue-100 transition-colors dark:bg-blue-500/10 dark:group-hover:bg-blue-500/20">
                  <FileText class="w-6 h-6 text-blue-600" />
                </div>
                <span class="text-xs font-bold uppercase tracking-wider text-blue-600 bg-blue-50 px-2 py-1 rounded-lg dark:bg-blue-500/10 dark:text-blue-300"
                  >Active</span
                >
              </div>
          ...
          >
            ...
            <div class="relative z-10">
              <div class="flex items-center justify-between mb-4">
                <div class="p-3 bg-red-50 rounded-2xl group-hover:bg-red-100 transition-colors dark:bg-red-500/10 dark:group-hover:bg-red-500/20">
          ...
          >
            ...
            <div class="relative z-10">
              <div class="flex items-center justify-between mb-4">
                <div class="p-3 bg-amber-50 rounded-2xl group-hover:bg-amber-100 transition-colors dark:bg-amber-500/10 dark:group-hover:bg-amber-500/20">
      ...
      <div class="space-y-6">
        ...
        <div class="bg-white rounded-3xl p-6 sm:p-8 border border-gray-200 dark:bg-slate-950 dark:border-slate-800">
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <!-- DB Info -->
            <div class="space-y-2">
              <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider dark:text-slate-500">Database</span>
            ...
            <!-- Version Info -->
            <div class="space-y-2">
              <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider dark:text-slate-500">Version</span>
              <p class="font-mono text-sm font-medium text-gray-700 dark:text-slate-200">v{{ stats.appVersion }}</p>
            </div>

            <!-- Security Info -->
            <div class="space-y-2">
              <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider dark:text-slate-500">Security</span>
              <div class="flex items-center gap-2 text-green-700 bg-green-100 px-3 py-1 rounded-full w-fit dark:text-green-300 dark:bg-green-500/10">
      ...
      <div class="space-y-8">
        ...
        <div class="text-center space-y-4">
          <h3 class="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 tracking-tight dark:text-slate-100">ZERO NOTE</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div
            class="group relative overflow-hidden bg-white rounded-3xl p-6 sm:p-8 border border-gray-200 hover:shadow-xl transition-all duration-300 dark:bg-slate-950 dark:border-slate-800"
          >
            <div
          ...
          <div class="group relative overflow-hidden bg-orange-600 rounded-3xl p-6 sm:p-8 hover:shadow-xl transition-all duration-300 dark:bg-orange-700">
            ...
            <div class="relative z-10">
              ...
              <p class="text-orange-50 mb-6 leading-relaxed">ZeroNote is free and ad-free. Support ongoing development with a donation.</p>
              <a
