    ...
    <div v-else class="space-y-12 animate-fade-in-up">
      ...
      <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div class="group bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 dark:bg-slate-950 dark:border-slate-800">
            <div class="w-12 h-12 bg-violet-50 rounded-xl flex items-center justify-center mb-4 group-hover:bg-violet-100 transition-colors dark:bg-violet-500/10 dark:group-hover:bg-violet-500/20">
          ...
          <div class="group bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 dark:bg-slate-950 dark:border-slate-800">
            <div class="w-12 h-12 bg-emerald-50 rounded-xl flex items-center justify-center mb-4 group-hover:bg-emerald-100 transition-colors dark:bg-emerald-500/10 dark:group-hover:bg-emerald-500/20">
